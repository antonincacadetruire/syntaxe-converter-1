...
referenceType :
  ...
  | arrayType;
classOrInterfaceType :
  (classType_lfno_classOrInterfaceType) (classType_lf_classOrInterfaceType)*;
classType :
...
primary :
  (primaryNoNewArray_lfno_primary) primaryNoNewArray_lf_primary*;
primaryNoNewArray :
  literal
  | typeName ('[' ']')* '.' 'class'
  | 'void' '.' 'class'
...
fieldAccess_lfno_primary :
  ...
  | typeName '.' 'super' '.' Identifier;
arrayAccess :
  (expressionName '[' expression ']') (primaryNoNewArray_lf_arrayAccess '[' expression ']')*;
arrayAccess_lf_primary :
...
arrayAccess_lfno_primary :
  (expressionName '[' expression ']') (primaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primary '[' expression ']')*;
methodInvocation :
